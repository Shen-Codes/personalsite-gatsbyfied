...
const socialIcons = social => {
   switch (social) {
      case 'twitter':
         return <FaTwitter color="black" size={30} />;
      case 'github':
         return <FaGithub color="black" size={30} />;
      case 'linkedin':
         return <FaLinkedin color="black" size={30} />;
      case 'youtube':
         return <FaYoutube color="black" size={30} />;
      default:
         return;
   }
};
            ...
            <ul className="social-links">
               {Object.keys(data.site.siteMetadata.social).map((s, i) => (
                  <li className="social-links__li" key={i + s}>
                     ...
                     <a href={data.site.siteMetadata.social[s]}>
                        {socialIcons(s)}
                     </a>
                  </li>
               ))}
